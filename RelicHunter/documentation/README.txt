=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
Relic Hunter Game Bot - Version 1.0
...
SETUP:
 ...
 1. Do a CLEAN install to C:\RelicHunterBot\  with the complete zip package of the bot.
...
Note, you do NOT have to install it to C:\RelicHunterBot\ However, it's recommended.
